import { getGuidelines, type ToolPack, WIDGET_MODULES } from '@aila/agent'
 ...
 */
export const WIDGET_TOOL_PACK: ToolPack = {
  id: 'widgets',
  name: 'Widget UI',
  description: 'Generate interactive visual widgets (charts, diagrams, mockups).',
  tools: [
    {
      spec: {
        type: 'function',
